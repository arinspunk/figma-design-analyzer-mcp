...
// Helper utility for text processing (mantenido para análisis de texto)
...
async function handleCommand(command, params) {
  switch (command) {
    // Funciones de análisis y lectura (mantenidas)
    ...
    default:
      throw new Error(`El comando "${command}" ya no está disponible. Este plugin ahora solo admite funciones de análisis y no permite modificar elementos de Figma.`);
  }
}
