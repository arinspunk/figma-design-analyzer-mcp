...
| Verify configuration | Check `claude_desktop_config.json` file | Contains configuration for "FigmaDesignAnalyzer" |
...
4. Open Claude Desktop and select the "FigmaDesignAnalyzer" MCP
...
| "Claude does not respond to Figma commands" | MCP not selected | Select "FigmaDesignAnalyzer" in the MCPs menu |
