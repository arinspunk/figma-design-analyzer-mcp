...
config.mcpServers['FigmaDesignAnalyzer'] = {
  command: 'npx',
  args: [`${packageName}@latest`]
};

console.log('Updated configuration for FigmaDesignAnalyzer:');
console.log(JSON.stringify(config.mcpServers['FigmaDesignAnalyzer'], null, 2));
...
try {
  ...
  console.log('2. Open Claude Desktop and select "FigmaDesignAnalyzer" from the MCPs list');
